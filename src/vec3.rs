...
impl Vec3 {
    ...
    pub fn random() -> Vec3 {
        Vec3(random::random_f64(), random::random_f64(), random::random_f64())
    }

    pub fn random_with_bounds(min: f64, max: f64) -> Vec3 {
        Vec3(random::random_f64_with_bounds(min, max), random::random_f64_with_bounds(min, max), random::random_f64_with_bounds(min, max))
    }
